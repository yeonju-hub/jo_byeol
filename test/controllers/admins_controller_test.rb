...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference('Admin.count') do
      post admins_url, params: { admin: { team_id: @admin.team_id, user_id: @admin.user_id } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { team_id: @admin.team_id, user_id: @admin.user_id } }
