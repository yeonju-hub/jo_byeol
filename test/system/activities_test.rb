...
class ActivitiesTest < ApplicationSystemTestCase
  ...
  test "creating a Activity" do
    ...
    fill_in "Attachment", with: @activity.attachment
    fill_in "Ppt", with: @activity.ppt
    fill_in "Research", with: @activity.research
    fill_in "Script", with: @activity.script
    fill_in "Team", with: @activity.team_id
